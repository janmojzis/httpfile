...
int cdb_make_addend(struct cdb_make *c,long long keylen,long long datalen,uint32 h)
{
...
int cdb_make_addbegin(struct cdb_make *c,long long keylen,long long datalen)
{
  char buf[8];
...
int cdb_make_add(struct cdb_make *c,const char *key,long long keylen,const char *data,long long datalen)
{
